...
const techSpecs = [
  ...
  {
    title: 'Training & Test Platform',
    icon: Waves,
    detail: 'Remotely operated training vessel for crew training, hull and propulsion testing, and payload integration trials — with a 40+ km long-range RC link.',
    stats: { label: 'Endurance', value: '10h+' },
    size: 'large',
    gradient: 'from-cyan-500/20 to-blue-500/20',
    platforms: ['all', 'usv'],
  },
  {
    title: 'Dual-Motor Propulsion',
    icon: Gauge,
    detail: 'Twin-motor drivetrain delivering 7 kg of combined thrust — carrying up to 20 kg of payload at 2.5 kts.',
    stats: { label: 'Thrust', value: '7 kg' },
    size: 'medium',
  ...
  },
  {
    ...
    icon: Gauge,
    detail: '2.4 caliber stability margin between center of gravity and center of pressure — straight, predictable flight.',
    stats: { label: 'Margin', value: '2.4' },
    size: 'medium',
